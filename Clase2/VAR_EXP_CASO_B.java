public class VAR_EXP_CASO_B {
    ...
    public static void main(String[] args){
        ...
        double v_media = (v1 + v2 + v3) / 3;
        double sigma = Math.sqrt((Math.pow((v1 - v_media), 2) + Math.pow((v2 - v_media), 2) + Math.pow((v3 - v_media), 2)) / 3);
        ...
        double w3 = 0.25;
        double w4 = 0.25;
        double score = w1 * 1/costoPorKm + w2*kml_total + w3 * 1/CO2_por_km + w4 * 1/sigma;
